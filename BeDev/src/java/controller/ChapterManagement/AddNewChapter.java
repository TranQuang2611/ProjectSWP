...
//        if (account.getRole().getRoleID() == 1) {
            ...
            boolean success = chapterDAO.insertChapter(courseId, chapterName, position, isActive);
            if (success) {
                session.setAttribute("addChapter", "success");
            } else {
                session.setAttribute("addChapter", "failed");
            }
