 ...
 * @author Admin
 */
@WebServlet(name = "CourseListPrice", urlPatterns = {"/CourseListPrice"})
public class CourseListPrice extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Course> listCourseByPrice = new ArrayList<>();
        for (Course course : listCourse) {
            if (course.getMoney() >= Double.parseDouble(lowPrice) && course.getMoney() <= Double.parseDouble(highPrice)) {
