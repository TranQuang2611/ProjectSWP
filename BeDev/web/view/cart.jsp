<%-- 
    Document   : cart
    Created on : May 18, 2022, 10:07:10 AM
    Author     : Admin
--%>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="cart-wizard-area">
                                <div class="image">
                                    <img src="dist/images/cart/01.jpg" alt="product" />
                                </div>
                                <div class="text">
                            ...
                            <div class="cart-wizard-area">
                                <div class="image">
                                    <img src="dist/images/cart/02.jpg" alt="product" />
                                </div>
                                <div class="text">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="summery-wizard">
                                ...
                                <form action="#">
                                    <a href="checkout.html" class="button button-lg button--primary form-control mb-lg-3">Checkout</a>
