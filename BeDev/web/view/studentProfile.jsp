                ...
                <div class="students-info-main">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            ...
                            <c:if test="${sessionScope.account.getRole().getRoleID()==2}">
                                <div class="tab-content__profile">
                                    <div class="tab-content__profile-content">
                                        <div class="info-student">
                                            <h6 class="font-title--card">${expert.getExpertName()} Information</h6>
                                            <dl class="row my-0 info-student-topic">
                                                <dt class="col-sm-4">
                                                    <span>Name</span>
                                                </dt>
                                                <dd class="col-sm-8">
                                                    <p>${expert.getExpertName()}</p>
                                                </dd>
                                            </dl>
                                            <dl class="row my-0 info-student-topic">
                                                <dt class="col-sm-4">
                                                ...
                                                <dd class="col-sm-8">
                                                    <p>${expert.getAccount().getEmail()}</p>
                                                </dd>
                                            </dl>
                                            <dl class="row my-0 info-student-topic">
                                                <dt class="col-sm-4">
                        ...
                        <div class="tab-pane fade" id="nav-completedcourses" role="tabpanel" aria-labelledby="nav-completedcourses-tab">
                            <div class="row">
                                <c:forEach items="${listCourseRegisterd}" var="c">
                                    <c:if test="${c.percentOfComplete==1}">
                                        <div class="col-lg-4 col-md-6 col-md-6 mb-4">
                                            <div class="contentCard contentCard--watch-course">
                                                <div class="contentCard-top">
                                                    <a href="CourseDetails?courseID=${c.courseID}"><img src="${c.courseImage}" alt="images" class="img-fluid" /></a>
                                            ...
                                            <form method="post">
                                                ...
                                                <c:if test="${sessionScope.account.getRole().getRoleID()==2}">
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12">
                                                            <label for="email">Email</label>
                                                            <input readonly="" type="email" id="email" name="email" class="form-control" placeholder="${expert.getAccount().getEmail()}" />
                                                        </div>
                                                    </div>
                                                    <div class="row g-3">
                                                        <div class="col-12">
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-12">
                                                            <label for="fname">Your Description</label>
                                                            <input type="text" class="form-control" name="des" value="${expert.getDescription()}" id="des" />
                                                        </div>
                                                    </div>
                                                </c:if>
